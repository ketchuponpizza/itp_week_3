...
filename = "/Users/alexjacobo/desktop/vit/intropython/week3/itp_week_3/day_1/lecture.xlsx"
...
# wb.get_sheet_name(sheet_name[0])
my_sheet = wb['Sheet1']
print(my_sheet)
...
new_cell = my_sheet.cell(row = 2, column = 2)
print(str(new_cell.value))

for i in range(1, 8):
    print(my_sheet.cell(row = i, column = 2).value)
# # READ DATA
