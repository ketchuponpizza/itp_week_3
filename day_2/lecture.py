...
my_newest_worksheet1 = my_new_workbook.create_sheet(
    "Mysheet")  # insert at the end of the sheets (default)
#or
my_newest_worksheet2 = my_new_workbook.create_sheet(
    "Mysheet", 0)  # insert at first position
#or
my_newest_worksheet3 = my_new_workbook.create_sheet(
    "Mysheet", -1)  # insert at penultimate position
